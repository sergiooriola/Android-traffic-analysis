...
def analyze_dynamic_tools(results):
    """Analyze differences in dynamic interaction tools."""
    data = []
    ...
    analysis_dir = create_directories(base_dir, "case1_tools_comparison")
